...
using MyTextBook.Sessions;
using MyTextBook.Web.Models.Account;
using MyTextBook.Web.Views.Shared.Components.TenantChange;

namespace MyTextBook.Web.Controllers
{
    public class AccountController : MyTextBookControllerBase
    {
